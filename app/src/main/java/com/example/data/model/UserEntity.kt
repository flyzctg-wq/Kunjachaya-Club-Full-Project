...
data class UserEntity(
    ...
    /**
     * Only the President or General Secretary can reassign a committee post
     * or edit another member's permission flags (ধারা-১৭) — this is the
     ...
     * - President/General Secretary may edit anyone, including other
     *   Executive Committee members (ধারা-১৭).
     * - An EC member holding canManageMembers may approve and manage
     *   ordinary (non-committee) members only — approving a member is an
     *   EC decision (ধারা-১০গ), but reassigning a committee seat stays with
     *   the President/GS above.
